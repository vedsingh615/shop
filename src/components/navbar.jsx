...
<div className="nav-icons">
  ...
  <a href="Cart" className="cart"> <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" fill="currentColor" className="cart4" viewBox="0 0 16 16">
